...
\begin{document}
	...
	\paragraph{} Diagramy sekwencji reprezentują przebieg działań wykonywanych w systemie. Zawierają one działanie zarówno aplikacji klienckiej jak i serwerowej przedstawiając pełny przebieg zdarzeń.
	\begin{figure}[H]
	...
	\paragraph{} Poniższe obrazy przedstawiają projekt graficzny aplikacji klienckiej.
